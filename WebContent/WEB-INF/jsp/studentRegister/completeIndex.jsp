...
<body>
	...
	<%-- <form id="ff" method="post" action="<%=basePath%>studentRegister/completeInfo"> --%>
		<table border="1" cellspacing=0 width="700px" height="300px" style="font-size:25px;">
			<caption style="font-weight: bold;margin-bottom:20px;height:30px;"> 基本信息展示 </caption>
			<tr>
			...
			<tr>
				<td  style="font-size:25px;"><label>高考成绩</label></td> 
					<td colspan="1" style="font-size:25px;"><input type="text" id="scores" name="scores" value="${sessionScope.student.scores}" class="inputCls" readonly="readonly"/></td>
